...
<pre>
<?php
    echo "Debugging shift_options for ride_id: " . htmlspecialchars($ride['ride_id']) . "\n";
    if (isset($ride['shift_options'])) {
        print_r($ride['shift_options']);
    } else {
        echo "No shift options available.\n";
    }
?>
</pre>
